...
Route::group(['middleware' => ['get.menu']], function () {
    ...
    Route::group(['middleware' => ['role:user']], function () {
        ...
        Route::prefix('stock')->group(function () {
            ...
            Route::get('/show', 'StockController@show')->name('stock.show');
            Route::post('/create', 'StockController@create')->name('stock.create');
        ...
        Route::prefix('supplier')->group(function () {
            ...
            Route::get('/edit', 'SupplierController@edit')->name('supplier.edit');
        ...
        Route::prefix('icon')->group(function () {  // word: "icons" - not working as part of address
